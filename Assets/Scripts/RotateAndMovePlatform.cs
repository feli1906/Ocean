...
public class RotateAndMovePlatform : MonoBehaviour
{
    ...
    [SerializeField] float endPositionX = 3.0f;
    [SerializeField] float endPositionY = 3.0f;
    [SerializeField] float endPositionZ = 3.0f;
    ...
    private void Awake()
    {
        ...
        _endPosition = new Vector3(_startPosition.x + endPositionX, _startPosition.y + endPositionY, _startPosition.z + endPositionZ);
    }
